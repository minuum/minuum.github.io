...
제가 **EdgeGround-VLA** 연구를 제1저자로 주도하며 구축한 이종 접지 인코더 융합 기술, 459M 중 1.128M만 학습하는 초경량 온디바이스 아키텍처 설계 노하우, 그리고 Jetson Orin NX + Serbot 2 환경에서 10Hz 비동기 제어 스택으로 온디바이스 95.0% 실기기 성공률을 달성한 실무 역량은 교수님의 연구실에서 진행 중인 강건한 VLA 알고리즘 및 로봇 제어 연구에 즉시 실질적인 동력이 될 것입니다.
