...
제가 MoNaVLA 프로젝트에서 주도한 VLA 백본(Kosmos-2, PaliGemma2)의 텍스트 경로 훼손 진단 및 2단계 분해(decomposition) 파이프라인 설계 경험, 그리고 실기기 3축 옴니휠 로봇 Serbot 2 상에서 Jetson Orin Linux + ROS2 드라이버를 구축하고 10Hz 비동기 제어 루프 및 Jitter Hold 필터링으로 물리적 지터/레이턴시를 극복한 엔지니어링 경험은, UNICON LAB의 로봇팀 및 자율주행 모빌리티 제어 연구에 즉시 실질적인 동력이 될 것입니다.
