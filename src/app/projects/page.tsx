        ...
        <main className="min-h-screen pt-24 px-6 pb-20">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-16">
                    ...
                    <Link href="/blog/mobile-vla-research" className="block">
                        <div className="group flex flex-col sm:flex-row sm:items-start gap-6 p-6 -mx-6 rounded-xl bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-blue-900/10 dark:to-purple-900/10 border border-blue-100 dark:border-blue-900/30 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
                            {/* Image Thumbnail */}
